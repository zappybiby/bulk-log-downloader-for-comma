...
- Production `downloads.html`, CSS and JavaScript interactions: source recognition, file scan, prepare ZIP and visible save state. A test-only adapter supplies a parser-generated synthetic source and synthetic fetch results at the browser API boundary; the production distributable never contains this adapter.
